...
import ValidationPhoneDriver from 'components/ValidationPhoneDriver';

export const DriverValidationScreen = ({navigation}: any) => {
  return (
      ...
      <ScrollView contentContainerStyle={tw`flex-grow`}>
        <View style={[tw`flex-1 justify-start items-center`, styles.container]}>
          ...
          <View
            ...
            <ValidationPhoneDriver navigation={navigation} />
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
